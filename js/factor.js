...
Factor.prototype.getButton = function() {
	...
	for(var i = 0;i < this.factor.length;i++) {
		ret += '<span style="border:1px solid blue;display:inline-block"><p class="top" style="text-align:right;color:red" onclick="div(' + this.factor[i] + ')"><i class="fa fa-times" aria-hidden="true"></i></p>';
